...
- **`query`**: `(to:quietlight@monkeyattack.com OR to:smbdealhunter@monkeyattack.com OR to:acqiireweekly@monkeyattack.com OR to:flippa@monkeyattack.com OR to:dealforce@monkeyattack.com OR to:joinaccresites@monkeyattack.com OR to:workweek@monkeyattack.com OR from:rejigg.com OR from:crexi.com) -label:deal-ingested`
